...
<h1 class="text-3xl font-bold mb-8">Add Client Password</h1>

<form action="{{ route('admin.client-passwords.store') }}" method="POST" class="max-w-3xl">
    @csrf
    ...
    <div class="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div class="pt-4">
            <button type="submit" class="bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600">Create Client Password</button>
        </div>
    </div>
</form>
@endsection
